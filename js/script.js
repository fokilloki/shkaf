...
inp.forEach(function (item, index) {
	item.addEventListener('click', function (e) {
		...
		function mathConstructor() {
			let sumConstructor = parseInt((base + (parseInt((iHeight - baseHeight) / 10 * step) + parseInt((iWidth - baseWidth) / 10 * step) + parseInt((iDepth - baseDepth) / 10 * step) + parseInt(iBoxes * 2500))) * parseFloat(iShkaf * 1));

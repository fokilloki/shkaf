...
let constructorForm = document.getElementById('constructor-form');

let inputHeight = constructorForm.elements.userheigt;
let inputWidth = constructorForm.elements.userwidth;
let inputDepth = constructorForm.elements.userdepth;
let inputBoxes = constructorForm.elements.userboxes;
let inputShkaf = constructorForm.elements.sliderinput;
...
function mathConstructor() {
	resultsConstructor.querySelector('span').innerHTML = parseInt(iHeight * 5) + parseInt(iWidth * 2) + parseInt(iDepth * 2) + parseInt(iBoxes * 2) + parseInt(iShkaf * 2);
